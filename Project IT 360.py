...
root = Tk()
root.title("Stenography - Hide a secret text message in an Image")
...
def Hide():
    ...
    secret = lsb.hide(str(Path(filename).name), message)

def Show():
    clear_message = lsb.reveal("/Users/theor/Downloads/w man.png")
